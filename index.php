...
<head>
    ...
    <title>Pelayanan Surat Keterangan Online Desa Durian Bungkuk</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/logotanahlaut.png" width="54" height="54" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="pendanaan.php">Pendanaan</a></li>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> DESA DURIAN BUNGKUK</h2>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh lurah, kemudian staf akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor  Desa Durian Bungkuk.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="contact">
        <div>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15922.226759289017!2d114.86257500728335!3d-3.9047105235139288!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de6f8c34e576b3b%3A0x77005c99aa801476!2sDurian%20Bungkuk%2C%20Kec.%20Batu%20Ampar%2C%20Kabupaten%20Tanah%20Laut%2C%20Kalimantan%20Selatan!5e0!3m2!1sid!2sid!4v1687364929156!5m2!1sid!2sid" width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi desa durian bungkuk"></iframe>  >
        </div>
    </section>
    <!--/#bottom-->

						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">FORM TAMBAH REQUEST SURAT KETERANGAN MENIKAH</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['kirim'])){
	...
	$sql = "INSERT INTO data_request_skm (nik,scan_ktp,scan_kk,scan_akta,scan_foto,keperluan) VALUES ('$nik','$xx','$yy','$zz','$ww','$keperluan')";

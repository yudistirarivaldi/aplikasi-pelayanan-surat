									...
									<div class="row">
											...
											<div class="col-md-6 col-lg-6">	
												...
												<div class="form-group">
													...
													<img src="../dataFoto/scan_skk/<?= $skk;?>" value="<?= $skk;?>" width="200" height="100" alt="">
												</div>
                                                <div class="form-group">
													<input type="file" name="skk" class="form-control" size="37">
												</div>
											</div>
									</div>
								</div>
...
if(isset($_POST['ubah'])){
	$keperluan = $_POST['keperluan'];
		...
		$nama_skk = isset($_FILES['ssk']);
    	$file_skk = $_POST['nik']."_".".jpg";
    $sql = "UPDATE data_request_skk SET
    keperluan='$keperluan',
    scan_ktp='$file_ktp',
    scan_kk='$file_kk', 
    scan_skk='$file_skk' WHERE id_request_skk=$id";
	$query = mysqli_query($konek,$sql);

	if($query){
		copy($_FILES['ktp']['tmp_name'],"../dataFoto/scan_ktp/".$file_ktp);
		copy($_FILES['kk']['tmp_name'],"../dataFoto/scan_kk/".$file_kk);
		copy($_FILES['skk']['tmp_name'],"../dataFoto/scan_skk/".$file_skk);

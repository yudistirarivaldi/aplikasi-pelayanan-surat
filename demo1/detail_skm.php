...
<?php
	if(isset($_GET['id_request_skm'])){
		$id_request_skm=$_GET['id_request_skm'];
		$sql = "SELECT * FROM data_request_skm natural join data_user WHERE id_request_skm='$id_request_skm'";
						...
						<div class="row">
								...
								<div class="card">
									<div class="card-header">
										...
										<label>Keterangan</label>
											...
											<a href="?halaman=sudah_acc_skm" class="btn btn-info btn-border btn-round btn-sm">
												Batal
											</a>
											</div>
									</div>
							...
							<div class="col-md-5">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row justify-content-md-center">
										<img src="../dataFoto/scan_photo/<?php echo $photo;?>" width="300" height="300" alt="">
										</div>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Akta</h4>
									</div>
									<div class="card-body">
										<div class="row justify-content-md-center">
										<img src="../dataFoto/scan_akta/<?php echo $akta;?>" width="300" height="300" alt="">
										</div>
									</div>
								</div>
							</div>
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			...
			$ubah = "UPDATE data_request_skm SET
		keterangan='$keterangan' WHERE id_request_skm='$id_request_skm'";
		$quey = mysqli_query($konek,$ubah);
		if($quey==1){
			echo "<script language='javascript'>swal('Selamat...', 'Ubah Berhasil', 'success');</script>" ;
			echo '<meta http-equiv="refresh" content="3; url=?halaman=sudah_acc_skm">';

		}
		  }else{
			echo "<script language='javascript'>swal('Gagal...', 'Ubah Gagal', 'error');</script>" ;
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_skm">';
		  }
	}
?>
										...
										<table id="add1" class="display table table-striped table-hover" >
											...
											<tbody>
                                                ...
                                                SELECT
                                                    data_user.nik,
                                                    data_user.nama,
                                                    data_request_skm.tanggal_request,
                                                    data_request_skm.keperluan,
                                                    data_request_skm.request,
                                                    data_request_skm.status
                                                FROM
                                                    data_user
                                                ...
                                                SELECT
                                                    data_user.nik,
                                                    data_user.nama,
                                                    data_request_skc.tanggal_request,
                                                    data_request_skc.keperluan,
                                                    data_request_skc.request,
                                                    data_request_skc.status
                                                FROM
                                                    data_user

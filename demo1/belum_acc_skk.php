									...
									<form action="" method="POST">
										<div class="table-responsive">
											<table id="add1" class="display table table-striped table-hover" >
												...
												<tbody>
													<?php
														$sql = "SELECT * FROM data_request_skk natural join data_user where status=1";
													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Surat" href="?halaman=view_skk&id_request_skk=<?= $id_request_skk;?>">
																<i class="fa fa-edit"></i></a>
															</div>
														</td>
													</tr>

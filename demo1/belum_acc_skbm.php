									...
									<form action="" method="POST">
										<div class="table-responsive">
											<table id="add1" class="display table table-striped table-hover" >
												...
												<tbody>
													<?php
														$sql = "SELECT * FROM data_request_skbm natural join data_user where status=1";
													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Surat" href="?halaman=view_skbm&id_request_skbm=<?= $id_request_skbm;?>">
																<i class="fa fa-edit"></i></a>
															</div>
														</td>
													</tr>

						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">FORM TAMBAH REQUEST SURAT KETERANGAN IZIN USAHA</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['kirim'])){
	...
	$keperluan = $_POST['keperluan'];
		...
		$sql = "INSERT INTO data_request_skp (nik,scan_ktp,scan_kk, keperluan) VALUES ('$nik','$xx','$ww','$keperluan')";

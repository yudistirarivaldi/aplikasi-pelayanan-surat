...
<?php
	...
	FROM
		data_user
	INNER JOIN data_request_skk ON data_request_skk.nik = data_user.nik
	WHERE month(data_request_skk.acc) = '$bulan'";
	$query = mysqli_query($konek,$sql);
	}
			    ...
			    <div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">LAPORAN PERBULAN REQUEST SURAT KETERANGAN KELAHIRAN</h2>
							</div>
						</div>
					</div>
                </div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-tools">
											<a href="cetak_bulan_skk.php?bulan=<?php echo $bulan;?>" target="_blank" class="btn btn-info btn-border btn-round btn-sm">

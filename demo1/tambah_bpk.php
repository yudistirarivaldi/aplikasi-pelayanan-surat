...
if(isset($_POST['simpan'])){
	...
	$sql = "INSERT INTO data_bpk (description, anggaran, realisasi, sisa) VALUES ('$description', '$anggaran', '$realisasi', '$sisa')";
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=tambah_bpk">';
	}
}
?>
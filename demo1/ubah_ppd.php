...
if (isset($_GET['description'])) {
    ...
    $tampil_description = "SELECT * FROM data_ppd WHERE description='$description'";
...
if (isset($_POST['ubah'])) {
    ...
    if ($query) {
        ...
        echo '<meta http-equiv="refresh" content="3; url=?halaman=ubah_ppd">';
    }
}
